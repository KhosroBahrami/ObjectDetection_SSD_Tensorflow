...
class SSD_network(object):
    ...
    def __init__(self): 
        ...
        # Resnet_V1
        self.feat_layers=['resnet_v1/block2', 'resnet_v1/block3', 'resnet_v1/block4', 'block13', 'block14', 'block15']
